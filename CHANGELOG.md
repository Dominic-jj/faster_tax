...
### Changed
- 文档同步：`README.md` 更新为当前应用流程（解析后可编辑、税收分类可下拉修正、下载按钮直接导出）
- 文档同步：`README.md` 补充 Chandra OCR 引擎说明与单位「排」支持说明
- 文档同步：`core/README.md` 的税收匹配打分规则更新为当前实现（说明命中权重、叶子节点偏好、仅说明命中降权）
